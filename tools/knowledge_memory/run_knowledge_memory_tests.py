...
RESULT_PATH = ROOT / "_generated" / "knowledge_memory_v1" / "KNOWLEDGE_MEMORY_TEST_RESULTS.md"
SNAPSHOT_PATHS = [
...
def main() -> int:
    ...
    steps = [
        ...
        ("SESSION_LOCAL_GATE_STATUS", ["tools/knowledge_memory/stage_gate.py"]),
    ...
    lines = [
        ...
        f"KNOWLEDGE_MEMORY_TEST_RESULT={overall}",
    ]
    ...
    print(f"KNOWLEDGE_MEMORY_TEST_RESULT={overall}")
