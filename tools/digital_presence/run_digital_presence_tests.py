...
RESULT_PATH = ROOT / "_generated" / "digital_presence_factory_v1" / "DIGITAL_FACTORY_TEST_RESULTS.md"
SNAPSHOT_PATHS = [
    ROOT / "_generated" / "commercial_agent_factory_v1" / "COMMERCIAL_AGENT_FACTORY_TEST_RESULTS.md",
    ROOT / "_generated" / "commercial_agent_factory_v1" / "COMMERCIAL_AGENT_FACTORY_VALIDATION_RESULTS.md",
    ROOT / "_generated" / "commercial_agent_factory_v1" / "COMMERCIAL_NO_SEND_STAGE_GATE.md",
    ROOT / "_generated" / "commercial_agent_factory_v1" / "commercial_no_send_shadow_result.json",
...
def main() -> int:
    ...
    steps = [
        ...
        ("DIGITAL_STAGE_GATE_RESULT", ["-c", "from tools.digital_presence.core import run_stage_gate; r=run_stage_gate(); print('SESSION_LOCAL_GATE_STATUS=' + r['status']); raise SystemExit(0 if r['status']=='PASS' else 1)"]),
    ...
    print(f"DIGITAL_FACTORY_TEST_RESULT={overall}")
