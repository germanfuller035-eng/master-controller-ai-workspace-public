...
export function runQA() {
  ...
  const dims = ['segment_fit', 'product_fit', 'claim_support', 'evidence', 'price', 'scope', 'channel_suitability', 'permission', 'privacy', 'capacity', 'measurement', 'brand_consistency', 'cta', 'opt_out', 'no_send'];
