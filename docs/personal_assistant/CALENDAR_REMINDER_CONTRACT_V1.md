# Calendar Reminder Contract V1

A calendar or reminder is represented as a draft object with a proposed title, timing label, reminder channel label, and calendar_write_allowed=false.
