# Automotive Operations Contract V1

Vehicle operations are represented as local task drafts only. Plate data, ownership records, payments, booking, and transactions are out of scope.
