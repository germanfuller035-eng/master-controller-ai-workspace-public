# Property Operations Contract V1

Property operations are represented as synthetic task drafts only. Real addresses, filings, payments, and transactions are out of scope.
