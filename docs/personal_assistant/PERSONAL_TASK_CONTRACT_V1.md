# Personal Task Contract V1

A personal task is represented by a synthetic task id, title, owner intent, data classes, draft status, approval flags, and a payload hash.
