...
Defines checks that deny actions exceeding allowed capability scope.

## Contract

- requested capability must be explicitly allowed
- unknown capability fails closed
- STOP active denies action
