...
Defines redaction before local logs or reports are written.

## Contract

- redact sensitive-looking keys
- redact provider credential-like values
- do not print raw values in validation failures
