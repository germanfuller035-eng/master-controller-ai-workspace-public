...
Documentation Agent writes local handoff, evidence, rollback, known limitation, validation, and stage-gate artifacts. It records that production stayed unchanged, outbound count stayed 0, payments stayed 0, and production DB writes stayed 0.
